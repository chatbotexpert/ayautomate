  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="flex flex-col overflow-hidden text-black dark:text-[#f0edee] w-full relative h-screen max-h-screen transition-colors duration-500">
        <div aria-hidden={true} className="absolute inset-0 z-[-1] pointer-events-none bg-no-repeat bg-cover bg-top opacity-75 dark:opacity-50" style={{ backgroundImage: "url('https://www.ayautomate.com/hero-pixel-mountains.webp')" }}></div>
